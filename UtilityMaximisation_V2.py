...
total_cons = np.array([])
total_cons = Loop_Slice(totalgoods,Clist,totalgoods)
...
total_factor_dd = Loop_Slice(totalfactors,Flist,totalfactors)
...
total_factor_ss = Loop_Slice(totalfactors,factor_list,totalfactors)
